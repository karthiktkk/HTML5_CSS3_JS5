define(['jquery','bs-js'],function($){
			$(document).ready(function(){
				...
				require( ['jquery', 'require-css!bootstrap', 'datatables.net', 'datatables-bs','require-css!datatables-css'], function(){	
					    $('#example').DataTable( {
							data: dataSet,
							columns: [
							{ title: "Name" },
...
define(['jquery','bootstrap','payment'],function($,bootstrap,payment){
